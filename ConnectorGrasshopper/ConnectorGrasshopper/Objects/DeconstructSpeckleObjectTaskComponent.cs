...
{
  public class DeconstructSpeckleObjectTaskComponent : SelectKitTaskCapableComponentBase<Base>,
    IGH_VariableParameterComponent
  {
    ...
    public DeconstructSpeckleObjectTaskComponent() : base("Extend Speckle Object", "ESO",
