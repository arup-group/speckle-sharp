...
namespace ConnectorGrasshopper.Streams
{
  public class StreamCreateComponent : GH_SpeckleComponent
  {
    ...
    protected override void RegisterInputParams(GH_InputParamManager pManager)
    {
      ...
      var jobNumber = pManager.AddTextParameter("Job Number", "JN", "8-digit job number associated with the stream (required by v2.speckle.arup.com, no spaces or dashes)",
        GH_ParamAccess.item);
